# -*- coding: utf-8 -*-
"""
Created on Sun Dec  8 21:06:31 2019
...
for dirname, _, filenames in os.walk('E:/NCI/translation/'):
    for filename in filenames:
        print(os.path.join(dirname, filename))
        
PATH = "../itranslation/hindi2english.csv"
...
UFFER_SIZE = len(input_tensor_train)
BATCH_SIZE = 64
